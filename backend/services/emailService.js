...
const statusMessages = {
  ...
  'rejected':    'Unfortunately, your request was not approved. Please visit the barangay office for more information.',
};

const sendStatusEmail = async (to, name, requestId, serviceType, status) => {
  try {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: #f9fafb; padding: 24px; border: 1px solid #e5e7eb;">
            ...
            <p style="color: #64748b;">${statusMessages[status] || 'Your request status has been updated.'}</p>
            <div style="background: white; border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin: 16px 0;">
              ...
              <p style="margin: 4px 0; color: #64748b;">
                ...
                <span style="color: #2563eb; font-weight: bold; text-transform: capitalize;">
                  ${status}
                </span>
              </p>
            </div>
          ...
          <div style="background: #f1f5f9; padding: 16px; border-radius: 0 0 8px 8px; text-align: center;">
            <p style="color: #94a3b8; font-size: 12px; margin: 0;">
              Barangay Service Portal — Do not reply to this email.
            </p>
          </div>
        </div>
      `,
